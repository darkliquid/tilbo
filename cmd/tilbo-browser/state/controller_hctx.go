...
var _ core.HandlerContext = (*Controller)(nil)
...
func (c *Controller) Publish(ctx context.Context, evt core.Event) {
...
func (c *Controller) LoadDir(path string, hidden bool) ([]core.DirectoryEntry, []string, error) {
...
func (c *Controller) SearchDaemon(ctx context.Context, chips []string, limit uint32) ([]core.SearchFile, error) {
	if c.daemon == nil {
		return nil, nil
	}
...
func (c *Controller) BuildPlaces() ([]core.PlaceEntry, error) {
	return BuildPlaces()
}
